...
def request_pagesource():    # 请求网页
    ...
    # chrome_options.add_argument(('--proxy-server=https://123.56.74.221:80'))
    ...
    for i in elementlist():
        ...
        # file = open('pagesource', 'w+', encoding='utf-8')
        # file.write(html)
        # file.close()
        # print(pagesource)
        ...
        time.sleep(random.randint(3, 9))
        # time.sleep(random.randint(3, 9))# '#J_Reviews > div > div.rate-page > div > a:nth-child(6 7 8 9 10 11 11 11 11 ...)'
        ...
        # js = 'var q=document.documentElement.scrollTop=40'
        # browser.execute_script(js)
        # element = WebDriverWait(browser, 20).until(
        #     EC.element_to_be_clickable((By.CSS_SELECTOR, '#J_Reviews > div > div.rate-page > div > a:nth-child(%i)' % i)))
        # # browser.find_element_by_css_selector('#J_Reviews > div > div.rate-page > div > a:nth-child(%i)' % i).click()
        # element.click()
        # break
    print('Finish')
